...
- (void)layoutIfNeeded {
    ...
    if ((*(int32_t *) (self->_attr.layer + 0x4) & 0x60000) == 0x0) {
        CA::Transaction *r14 = CA::Transaction::ensure_compat();
        int32_t rax = *(int32_t *) (r14 + 0x20);
        *(int32_t *) (r14 + 0x20) = rax + 0x1; // r14.prop  ++
        if (rax == 0x0) {
        ...
        if (rcx != 0x0) {
            rcx = rcx + *_OBJC_IVAR_$_CALayer._attr;
            do {
                rdx = *(int32_t *) rcx + 0x1;
                if (rdx < 0x2) {
                    break;
...
- (void)setNeedsLayout {
    rbx = *(self + *_OBJC_IVAR_$_CALayer._attr + 0x8);
